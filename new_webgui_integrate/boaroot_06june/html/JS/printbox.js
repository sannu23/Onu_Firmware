...
//style=\"word-wrap:break-word\"
	...
	PrintBuf += ('</TABLE>');
    PrintBuf =  PrintBuf + '<BR><table><tr><td><INPUT type=\"button\"  class="btns"  id=add name=add value = '+'\''+add+'\''+' onclick = \"webClickAdd('+'\''+strDomainName+'\''+','+'\''+strUrl+'\''+');\">';
	PrintBuf =  PrintBuf + '&nbsp;<INPUT type=\"button\" class="btns"  id=delete name=delete value = '+'\''+del+'\''+' onclick = \"webClickRemove();\"></td></tr></table>';
