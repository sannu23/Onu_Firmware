...
<HTML><HEAD><TITLE><%tcWebApi_get("String_Entry","RouteText","s")%></TITLE>
...
onload="DisplayLocation(getElement('Selected_Menu').value);FinishLoad();if(getElById('StaticRouteForm') != null)LoadFrame()" 
...
border=0>
        ...
        <TR>
          ...
          <TD width=434 bgColor=#427594 height=33>
            ...
            value="<%tcWebApi_get("String_Entry","ContentNetText","s")%>-><%tcWebApi_get("String_Entry","ContentRouteText","s")%>" name=Net_Routeset> </FONT></B><SPAN 
...
MakeMenu(getElById ('Selected_Menu').value);
  ...
  <TR>
	...
	var Route_Delete = "<% tcWebApi_get("String_Entry","Delete1Text","s") %>";
	var Route_Add = "<% tcWebApi_get("String_Entry","Add1Text","s") %>";
...
function CheckRoutesActives()
{
	...
	vcurLinks[nCurTemp++] = new Array("cgi-bin/net-routeadd.asp","", "InternetGatewayDevice.Layer3Forwarding.Forwarding", "<%tcWebApi_get("String_Entry","DestinationIPText","s")%> ", "<%tcWebApi_get("String_Entry","GatewayText","s")%>", "<%tcWebApi_get("String_Entry","SubnetMaskText","s")%>", "<%tcWebApi_get("String_Entry","InterfaceText","s")%>");
...
{
alert('<%tcWebApi_get("String_Entry","NoWANCreateText","s")%>');
return false;
}
return true;
}
...
//top.ripIndex = Interface.selectedIndex;
	...
	if( true == setEBooValueCookie(document.RipCfg) )
      ...
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0 id="mainTableSet">
        ...
        <TR>
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1><%tcWebApi_get("String_Entry","StaticRouteText","s")%></P></TD>
        ...
        <TR>
          ...
          <TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
	        	<TD><P><font color=red><%tcWebApi_get("String_Entry","StaticRouteMaxCountText","s")%></font></P></TD>
	          </TR>
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>
...
printInstNoEditBox('StaticRoute',400);
                        ...
                        <input type="hidden" id="hSrouteFlag1" name="hSrouteFlag1" value="17">
                        <input type="hidden" id="hSrouteFlag2" name="hSrouteFlag2" value="17">
                        <input type="hidden" id="hSrouteFlag3" name="hSrouteFlag3" value="17">
                        <input type="hidden" id="hSrouteFlag4" name="hSrouteFlag4" value="17">
                        <input type="hidden" id="hSrouteFlag5" name="hSrouteFlag5" value="17">
                        <input type="hidden" id="hSrouteFlag6" name="hSrouteFlag6" value="17">
                        <input type="hidden" id="hSrouteFlag7" name="hSrouteFlag7" value="17">
						<input type="hidden" id="hSrouteFlag8" name="hSrouteFlag8" value="17">
						<input type="hidden" id="hSrouteFlag9" name="hSrouteFlag9" value="17">
						<input type="hidden" id="hSrouteFlag10" name="hSrouteFlag10" value="17">
						<input type="hidden" id="hSrouteFlag11" name="hSrouteFlag11" value="17">
						<input type="hidden" id="hSrouteFlag12" name="hSrouteFlag12" value="17">
						<input type="hidden" id="hSrouteFlag13" name="hSrouteFlag13" value="17">
						<input type="hidden" id="hSrouteFlag14" name="hSrouteFlag14" value="17">
						<input type="hidden" id="hSrouteFlag15" name="hSrouteFlag15" value="17">
        ...
        <TR id="DynaRouteInfo1">
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1><%tcWebApi_get("String_Entry","DynamicRouteText","s")%></P></TD>
          <TD width=7 bgColor=#ef8218>　</TD>
          <TD width=474>　</TD></TR>
        <TR>
          <TD vAlign=top width=157 bgColor=#e7e7e7 height=10></TD>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                  ...
                  <TABLE cellSpacing=0 cellPadding=3 width=400 border=1>
                    <TBODY>
                    <TR align=middle>
                              <TD class=table_title><%tcWebApi_get("String_Entry","InterfaceText","s")%>
	...
	for (var i = 0; i < nEntryNum; i++)
	{
			...
			if(document.RipCfg.curSet_Flag.value == vEntryIndex[i])
				document.RipCfg.sel_Interface.selectedIndex= i;
                      ...
                      <TD class=table_title><%tcWebApi_get("String_Entry","OperationText","s")%></TD>
                      <TD class=table_title><%tcWebApi_get("String_Entry","VersionText","s")%></TD></TR>
                    <TR align=middle>
...
//ChangeInterface(obj);
					...
					<INPUT onclick="btnRipSave()" type=button id=RipSave name=RipSave value="<%tcWebApi_get("String_Entry","SaveAndApplyText","s")%>"> 
                  </P></TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
        ...
        <TR>
          ...
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1>IPv6 <%tcWebApi_get("String_Entry","StaticRouteText","s")%></P></TD>
          <TD width=7 bgColor=#ef8218>　</TD>
        <% else %>
                    ...
                    <TR>
                      <TD>
                        <TABLE cellSpacing=1 cellPadding=3 width=400 border=1>
                          <TBODY>
                          <TR align=middle>
                            <TD class=table_title align=middle><%tcWebApi_get("String_Entry","DestinationIPText","s")%></TD>
                            <TD class=table_title align=middle><%tcWebApi_get("String_Entry","GatewayText","s")%></TD>
                            <TD class=table_title align=middle><%tcWebApi_get("String_Entry","InterfaceText","s")%></TD>
                            <TD class=table_title align=middle><%tcWebApi_get("String_Entry","EnableText","s")%></TD>
                            <TD class=table_title align=middle><%tcWebApi_get("String_Entry","Delete1Text","s")%></TD></TR>
                          <SCRIPT language=JavaScript type=text/javascript>
...
{
str = "<%tcWebApi_get("String_Entry","EnableText","s")%>";
}
else
{
str = "<%tcWebApi_get("String_Entry","DisableText","s")%>";
}
...
document.write('</TR>');
                                ...
                                <input type="hidden" id="route6flag" name="route6flag" value="0">
                                <input type="hidden" id="route6delflag0" name="route6delflag0" value="17">
								<input type="hidden" id="route6delflag1"  name="route6delflag1" value="17">
                                <input type="hidden" id="route6delflag2" name="route6delflag2" value="17">
                                <input type="hidden" id="route6delflag3" name="route6delflag3" value="17">
                                <input type="hidden" id="route6delflag4" name="route6delflag4" value="17">
                                <input type="hidden" id="route6delflag5" name="route6delflag5" value="17">
                                <input type="hidden" id="route6delflag6" name="route6delflag6" value="17">
                                <input type="hidden" id="route6delflag7" name="route6delflag7" value="17">
                                <input type="hidden" id="route6delflag8" name="route6delflag8" value="17">
                                <input type="hidden" id="route6delflag9" name="route6delflag9" value="17">
                                <input type="hidden" id="route6delflag10" name="route6delflag10" value="17">
                                <input type="hidden" id="route6delflag11" name="route6delflag11" value="17">
                                <input type="hidden" id="route6delflag12" name="route6delflag12" value="17">
                                <input type="hidden" id="route6delflag13" name="route6delflag13" value="17">
                                <input type="hidden" id="route6delflag14" name="route6delflag14" value="17">
                                <input type="hidden" id="route6delflag15" name="route6delflag15" value="17">
                                <BR>
                                <LEFT><INPUT id=btnAdd name=btnAdd onclick="AddStaticRt()" type=button value="<%tcWebApi_get("String_Entry","Add1Text","s")%>"> 
                        &nbsp; <INPUT id="btnRemove" name="btnRemove" onclick="removeClick(this.form.rml)" type=button value="<%tcWebApi_get("String_Entry","Delete1Text","s")%>"> 
      ...
      <TABLE id=table7 height=35 cellSpacing=0 cellPadding=0 width=808 
        ...
        <TR>
          ...
          <TD width=196 bgColor=#427594>
            <P align=center><IMG id=btnOK onclick="" height=23  src="<%tcWebApi_get("String_Entry","IMGOKText","s")%>" width=80 border=0>&nbsp;&nbsp;<IMG 
