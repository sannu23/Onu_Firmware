...
<% end if %> 
                        ...
                        <TABLE id=table2 name=table2 height=100 cellSpacing=0 cellPadding=0 width=808 border=0>
                            <TBODY>
                                <TR>
                                                    ...
                                                    <!-- start -->
																						        ...
																						        <TABLE class=table1_bg border=0 cellSpacing=1 cellPadding=0 width="100%">
																						            <TBODY>
																								        ...
																								        <TABLE class=table1_bg border=0 cellSpacing=1 cellPadding=0 width="100%">
																								            <TBODY>
																								                ...
																								                <TR>
																								                    ...
																								                    <TD class=table1_right colSpan=2 align=left>
																								                        <SELECT id=X_HW_PortName_RTP name=X_HW_PortName_RTP maxlength="30">
																								                            <SCRIPT language=JavaScript type=text/javascript>
																								                            ...
																								                            <TBODY>
																								                                <TR>
																								                                    ...
																								                                    <TD class=table1_submit>
																								                                        <INPUT class=submit onclick=SubmitInterface(); value=应用 type=button id=btnApplySipServer name=btnApplySipServer>
																								                                        <INPUT class=submit onclick=CancelConfig(); value=取消 type=button id=cancelValue name=cancelValue>
																								                                    </TD>
																								                                </TR>
																								                            </TBODY>
																								                        </TABLE>
																								        ...
																								        <TABLE style="TABLE-LAYOUT: fixed; WORD-BREAK: break-all; margin-top:0px;" id=voipUserTable name=voipUserTable
																								                ...
																								                <TBODY>
																								                    <TR>
																								                        ...
																								                        <TD class=table1_right width="75%" colSpan=2 align=left>
																								                            <INPUT size=18 CHECKED type=checkbox id=Enable name=Enable>
																								                        </TD>
																								                    </TR>
																								                    <TR>
																								                        <TD class=table1_left width="25%" align=left>
																								                        ...
																								                        <TD class=table1_right width="75%" colSpan=2 align=left>
																								                            <INPUT style="WIDTH: 155px" maxLength=389 type=text id=URI name=URI>
																								                            <SPAN class=gray>
																								                                (URI)
																								                            </SPAN>
																								                        </TD>
																								                    ...
																								                    <TR>
																								                        ...
																								                        <TD class=table1_right width="75%" colSpan=2 align=left>
																								                            <INPUT style="WIDTH: 155px" maxLength=256 type=text id=DirectoryNumber name=DirectoryNumber>
																								                            <SPAN class=gray>
																								                                (电话号码)
																								                            </SPAN>
																								                        </TD>
																								                    ...
																								                    <TR>
																								                        ...
																								                        <TD class=table1_right width="75%" colSpan=2 align=left>
																								                            <SELECT style="WIDTH: 40px" id=PhyReferenceList name=PhyReferenceList>
																								                                <SCRIPT language=JavaScript type=text/javascript>
																								                                    var k;
																								                                    document.write('<option value="" id="null">' + '' + '<\/option>');
																								                    ...
																								                    <TR>
																								                        ...
																								                        <TD class=table1_right width="75%" colSpan=2 align=left>
																								                            <INPUT style="WIDTH: 155px" maxLength=256 type=text id=AuthUserName name=AuthUserName>
																								                            <SPAN class=gray>
																								                                (长度0-64)
																								                            </SPAN>
																								                        </TD>
																								                    ...
																								                    <TR>
																								                        ...
																								                        <TD class=table1_right width="75%" colSpan=2 align=left>
																								                            <INPUT style="WIDTH: 155px" maxLength=256 type=password id=AuthPassword name=AuthPassword>
																								                            <SPAN class=gray>
																								                                (长度0-64)
																								                            </SPAN>
																								                        </TD>
																								                            ...
																								                            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
																								                                <TBODY>
																								                                    <TR>
																								                                        ...
																								                                        <TD class=table1_submit>
																								                                            <INPUT class=submit onclick=Submit(); value=应用 type=button id=btnApplySipUser name=btnApplySipUser>
																								                                            <INPUT class=submit onclick=CancelUserConfig(); value=取消 type=button id=cancelValue name=cancelValue>
																								                                        </TD>
																								                                    </TR>
																								                                </TBODY>
																								                            </TABLE>
