...
%>
<HTML><HEAD><TITLE><%tcWebApi_get("String_Entry","UPNP1Text","s")%></TITLE>
...
border=0>
        ...
        <TR>
          ...
          <TD width=434 bgColor=#427594 height=33>
            ...
            value="<%tcWebApi_get("String_Entry","ContentAPPText","s")%>-><%tcWebApi_get("String_Entry","ContentUPNPText","s")%>" name=Selected_Menu> </FONT></B><SPAN 
      ...
      <TD vAlign=top> 
        ...
        <TR>
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1><%tcWebApi_get("String_Entry","UPNP1Text","s")%></P></TD>
...
<% end if %>
        ...
        <TR>
          ...
          <TD width=7 background=/img/panel3.gif>　</TD>
          <TD>
            <FORM id="ConfigForm" name="ConfigForm" action="/cgi-bin/app-upnp.asp" method="post">
            <TABLE cellSpacing=10 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD>
                  ...
                  <TABLE cellSpacing=3 cellPadding=3 border=0>
                    <TBODY>
                    <TR>
                      <TD><%tcWebApi_get("String_Entry","UPNP2Text","s")%></TD>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD><input type="hidden" id="Upnp_Flag" name="Upnp_Flag" value="0">
                	<input type="hidden" id="AutoConfig_Flag" name="AutoConfig_Flag" value="<% tcWebApi_get("Upnpd_Entry","autoconf","s") %>">
                          <input type="hidden" id="Enable_Flag" name="Enable_Flag" value="<% tcWebApi_get("Upnpd_Entry","Active","s") %>"> 
