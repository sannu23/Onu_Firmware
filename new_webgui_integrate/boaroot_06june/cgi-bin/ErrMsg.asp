...
{	
		...
		with (getElById('ConfigForm'))
		{
			...
			tdResultElement.innerHTML = '<P><strong><font color="#FF0000" size="2">原密码输入错误，密码设置失败！</font></strong></P>';
		}
}
</SCRIPT>
        ...
        <TR>
          ...
          <TD>
            <FORM name=ConfigForm>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD><A href="/cgi-bin/mag-account.asp"><SPAN class=logout>返回重设</SPAN></A></TD>
