...
<html lang="en">
    ...
    <body onload="FinishLoad();if(getElById('UrlFilterForm') != null)LoadFrame()" onunload="DoUnload()"
               <INPUT id=Selected_Menu type=hidden
                value="Security->N/A" name=Selected_Menu>
                ...
                <ul class="scoop-submenu" id="HelpMenu"></ul>
                    ...
                    <div class="scoop-content">
                        <div id="Header">
                                ...
                                MakeHeader('Gateway Name:','Gateway Type:','Security','N/A','Welcome!','N/A');
                                </SCRIPT>
                            </div>
                        <div class="">
                             ...
                             <div class="scoop-inner-content">
                                                              ...
                                                              <h1 class="heading_big bei pb-3">URL Filter</h1>
    
                                                                    <div class="white_box">
                                                                            <h1 class="heading_grey"><img src="../img/wan.png" width="95" height="50" class="img_sub" alt=""/ style="padding:5px;"><span style="vertical-align:middle;">URL Settings</span></h1>
                                ...
                                <input type="hidden" id="EnableUrlFilterFlag" name="EnableUrlFilterFlag" value="1">
                                <input type="hidden" id="delnum" name="delnum" value="">
                                <input type="hidden" id="add_num" name="add_num" value="0">
                                <input type="hidden" id="Url_num" name="Url_num" value="0">
    
                                                                            <div class="container-fluid">
                                                                            <hr class="margin_adjs" />
                                        <div class="lighter_grey_bg">
                                        <label>Not support IPv6 mode</label>
                                        </div>
                                                                            <div class="row">
                                                                                    <div class="col-md-6 form-group">
                                                                                            <div class="custom-control custom-checkbox">
                                                <input id="enableFilter" onclick="cliEnableBox(this)" class="custom-control-input" type="checkbox" name="enableFilter"  <%if tcWebApi_get("UrlFilter_Common","Activate","h") = "1" then asp_Write("checked") end if%>>
                                                                                              <label class="custom-control-label" for="enableFilter">Enable: </label>
                                                                                            </div>
                                                                                    </div>
                                                                                    </div>
                                                    <div class="row col-md-12" id="Filter">
                                                                                    <div class="row lighter_grey_bg">
                                          <p> Set the URL filtering mode and the filter list. (can set up 100)</p>
    
                                         <p>Click the &quot;change mode&quot; button to change the URL filtering mode,</p> <p>Click the &quot;add button&quot; to add a URL to the corresponding URL list, Click the delete button to remove a URL,</p>
                               <p> The URL should not cintains &quot;http://&quot; or &quot;https://&quot; prefix, and the URL length should not exceed 31 characters. </p>
                               <p>
                      <SCRIPT language=JavaScript type=text/javascript>
                          setDisplay('Filter', enbl);
                          if (urlfltpolicy == "0") {
                              document.write('The current filter list is:<B>blacklist</B>\n');
                          }
                          else {
                              document.write('The current filter list is:<B>White list</B><BR>\n');
                              document.write('<font color="#FF0000">Tip: the URL you are filling in will match the URL you are accessing</font>');
                          }
    </SCRIPT></p>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                    <div class="col-md-12 form-group">
                                                                                            <h2 class="sub_heading" style="color:#fd7e14;"><%tcWebApi_get("String_Entry","WanSetting18Text","s")%> </h2>
                                                                                            <div class="custom-control custom-radio custom-control-inline">
                                                <!--<input id="FilterPolicy" onclick="ChangePolicy()" type="radio" value="0"  class="custom-control-input" name="FilterPolicy" />
                                                                                                      <label class="custom-control-label" for="FilterPolicy">blacklist </label>-->
                                                      <input id="FilterPolicy" onclick="ChangePolicy()" type=radio value="0" name="FilterPolicy"  <%if tcWebApi_get("UrlFilter_Common","Filter_Policy","h") = "0" then asp_Write("checked")  end if%>><%tcWebApi_get("String_Entry","WanSetting14Text","s")%> 
    
                                                                                                    </div>
                                                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                   <!-- <INPUT id=FilterPolicy onclick="ChangePolicy()" type=radio value="1" name="FilterPolicy" checked>
                                                                                                      <label class="custom-control-label" for="customRadioInline2">Whitelist</label>-->
                                                        ...
                                                        <input id="FilterPolicy" onclick="ChangePolicy()" type=radio value="1" name="FilterPolicy" <%if tcWebApi_get("UrlFilter_Common","Filter_Policy","h") = "1" then asp_Write("checked") end if%>><%tcWebApi_get("String_Entry","WanSetting16Text","s")%> 
                                                                                            ...
                                                                                            <div class="col-md-4 form-group" id="FilterPolicy">
                                                                                            <label>URL</label>
                                                                                            <div class="input-group btn_combo">
                                                                                     <input onkeydown="if(event.keyCode==13)return false" maxLength="31" size="30" name="urlitem" class="form-control"/>
                                                                                      <div >
                                                                                            <span>
                                                <input onclick="btnAdd()" class="btn btn-orang" id="buttonAdd" name="buttonAdd" type="button" value=" Add  ">
                                                </span>
                                                                                      </div>
                                                                                      </div>
                                                                                    </div>
                          ...
                          <div class="row col-md-12" id="ddnsInfo">
                                          <!--<iframe src="/cgi-bin/sec_urlfilterlist.cgi" frameborder="0" width="350"></iframe>-->
                                <table class="table table-bordered table_text_center" style="text-align:center;font-size:13px;background-color:#eee;" id="url_Info" name="url_Info">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="tbody">
                                                                                            ...
                                                                                            <div class="col-md-12 form-group">
                                                <INPUT onclick='btnRemove(this.form.rml)'  class="btn btn-orang " id="buttonRemove" name="buttonRemove" type=button value=" Delete ">
                                                                                    </div>
                                                                                    </div>
                                                                                    </div>
                                                                                    <hr class="margin_adjs" />
                                                                                    <div class="form-footer text-right">
                                                                                    <button id="btnOK" onclick="SubmitForm()" class="btn btn-orang btn-lg" type="button">OK</button>
                                                                                    <button id="btnCancel" onclick="RefreshPage()" class="btn btn-secondary btn-lg" type="button">CANCEL</button>
                                                                                    </div>
                                                                    </div>
                                    </form>
                                                            </div>
