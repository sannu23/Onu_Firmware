...
<head>
   ...
   <title>Firewall</title>    <link href="/css/scoop-vertical.css" rel="stylesheet">
		...
		<svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38"> 
          ...
          <div class="scoop-content">
                        <div id="Header">
                            ...
                            MakeHeader('Gateway Name:','Gateway Type:','Security','Firewall','Welcome!','N/A');
                            </SCRIPT>
                        </div>
                        <div class="">
                             ...
                             <div class="scoop-inner-content">
                                                          ...
                                                          <h1 class="heading_big bei pb-3">Firewall</h1>

                                                                <div class="white_box">
                                                                        <h1 class="heading_grey"><img src="../img/firrewall.png" width="55" height="60" class="img_sub" alt=""/><span style="vertical-align:middle;">Security Level</span></h1>
                                                                        <div class="container-fluid">
                                                                        <hr class="margin_adjs" />
                                     <FORM name="ConfigForm" action="/cgi-bin/sec-firewall.asp" method="post" class="row">
                                     <input type="hidden" id="Fire_Flag" name="Fire_Flag" value="0">
                        <input type="hidden" id="SPIFW_Flag" name="SPIFW_Flag" value="0">
                <input type="hidden" id="EnableFire_Flag" name="EnableFire_Flag" value="0">

                                                                                <div class="col-md-3 form-group">
                                                                                        <label><%tcWebApi_get("String_Entry","Firewall3Text","s")%></label>
                                            <SELECT class="custom-select" onchange="ChangeLevel(this)" size=1 id="SecurityLevel" name="SecurityLevel">
                                  ...
                                  <OPTION value="high" <%if tcWebApi_get("Firewall_Entry","firewall_level","h") = "high" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","Firewall6Text","s")%></OPTION>
                                                                ...
                                                                <div class="white_box">
                                                                        <h1 class="heading_grey" id="protectatack1"><img src="../img/shield.png" width="45" height="40" class="img_sub" alt=""/><span style="vertical-align:middle;"> <%tcWebApi_get("String_Entry","Firewall7Text","s")%></span></h1>
                                                                        <div class="container-fluid">
                                                                        <hr class="margin_adjs" id="protectatack2"/>
                                                                        <div class="row" id="protectatack3">
                                                                                <div class="col-md-12 form-group" id="AttackProtect">
                                                                                        <div class="custom-control custom-checkbox">
                                            <INPUT id="enableAttackProtect"  class="custom-control-input" onclick="setAttackProtect()" type="checkbox" name="enableAttackProtect"       <%if tcWebApi_get("Firewall_Entry","firewall_status","h") = "1" then asp_Write("checked") end if%> >
                                                                                          <label class="custom-control-label" for="enableAttackProtect"><%tcWebApi_get("String_Entry","Firewall8Text","s")%></label>
                                                                                        </div>
                                                                                </div>
                                                                                </div>
                                                                                ...
                                                                                <button class="btn btn-orang btn-lg" type="button" id="btnOK" onclick="SubmitForm()">OK</button>
