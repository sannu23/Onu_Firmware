      ...
      <TABLE id=table2 height=100 cellSpacing=0 cellPadding=0 width=808 border=0>
        ...
        <TR>
          ...
          <TD width=434 bgColor=#427594 height=33>
            ...
            <B><FONT face=ºÚÌå color=#ffffff size=6>
            	<INPUT id=Selected_Menu type=hidden value="Ó¦ÓÃ->VPN" name=Selected_Menu> 
            </FONT></B>
            <SPAN class=GatewayName>Íø¹ØÃû³Æ:
            <SCRIPT language=javascript>
          ...
          <TD width=211 bgColor=#ef8218 height=33>
            <P class=GatewayType align=center>ÐÍºÅ:
            <SCRIPT language=javascript>
