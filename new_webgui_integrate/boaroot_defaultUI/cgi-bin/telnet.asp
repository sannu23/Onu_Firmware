          ...
          <TD vAlign=bottom align=right width=358>
            <TABLE id=table8 cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR>
                ...
                <TD vAlign=bottom align=middle width=100><%tcWebApi_get("String_Entry","WelcomeSettingText","s")%></TD>
                <TD vAlign=bottom width=70><A href="/cgi-bin/index.asp" target=_top><%tcWebApi_get("String_Entry","HomeBtnText","s")%>
      ...
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1><%tcWebApi_get("String_Entry","TelManText","s")%></P></TD>
...
<% end if %>
        ...
        <TR>
          ...
          <TD width=7 background=/img/panel3.gif>　</TD>
          <TD>
            <FORM id="ConfigForm" name="ConfigForm" action="/cgi-bin/telnet.asp" method="post">
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>
                     <input type="hidden" id="telnet_flag" name="telnet_flag" value="0">
					 <input type="hidden" id="telnetenable_flag" name="telnetenable_flag" value="<% tcWebApi_get("Account_TelnetEntry","Active","s") %>">
               	</TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>
				<%tcWebApi_get("String_Entry","TelSetText","s")%><INPUT id="enabletelnet" onclick="setTelnet()" type="checkbox" name="enabletelnet" <%if tcWebApi_get("Account_TelnetEntry","Active","h") = "Yes" then asp_Write("checked") end if%>>
				</TD>
