...
<% end if %>
	...
	switch(node_idx)
	{
			case 1:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry0","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry0","EncrypType","s") %>";
				break;
			case 2:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry1","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry1","EncrypType","s") %>";
				break;
			case 3:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry2","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry2","EncrypType","s") %>";
				break;
			case 4:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry3","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry3","EncrypType","s") %>";
				break;
			case 5:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry4","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry4","EncrypType","s") %>";
				break;
			case 6:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry5","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry5","EncrypType","s") %>";
				break;
			case 7:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry6","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry6","EncrypType","s") %>";
				break;
			case 8:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry7","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry7","EncrypType","s") %>";
				break;
			case 9:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry8","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry8","EncrypType","s") %>";
				break;
			case 10:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry9","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry9","EncrypType","s") %>";
				break;
			case 11:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry10","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry10","EncrypType","s") %>";
				break;
			case 12:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry11","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry11","EncrypType","s") %>";
				break;
			case 13:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry12","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry12","EncrypType","s") %>";
				break;
			case 14:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry13","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry13","EncrypType","s") %>";
				break;
			case 15:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry14","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry14","EncrypType","s") %>";
				break;
			case 16	:
				...
				wl_authMode = "<% tcWebApi_get("WLan11ac_Entry15","AuthMode","s") %>";
				wl_encrypType = "<% tcWebApi_get("WLan11ac_Entry15","EncrypType","s") %>";
				break;
			default:
				bss_gl_al_mac = "";
				bss_gl_fh_support = 0;
								...
								<TABLE cellSpacing=0 cellPadding=0 border=0 >
									<TBODY>
										...
										<TR>
											...
											<TD><INPUT TYPE="TEXT" NAME="PreSharedKey_WPA2WPA3" STYLE="WIDTH:140" SIZE="48" MAXLENGTH="64" VALUE="<% If tcWebApi_get("WLan11ac_Entry","WPAPSK","h") <> "N/A" then tcWebApi_get("WLan11ac_Entry","WPAPSK","s") end if %>" onBlur="wpapskCheck(this)">(8~63个字符或64个十六进制字符串)</TD>
										</TR>
										<TR class='hide' style="display: none">
											<TD width="130"><%tcWebApi_get("String_Entry","KeyRenwalText","s")%></TD>
											<TD><INPUT TYPE="TEXT" id="keyRenewalInterval_WPA2WPA3" NAME="keyRenewalInterval_WPA2WPA3" SIZE="7" MAXLENGTH="7" onBlur="checkRekeyinteral(this.value, 0)">秒 (0 ~ 4194303)
												<script language="JavaScript" type="text/JavaScript">
													var rekeystr = "<% tcWebApi_get("WLan11ac_Entry","RekeyInterval","s") %>";
													if("N/A" == rekeystr || "" == rekeystr)
							...
							<div id="WPA3PSK_div">
								<TABLE cellSpacing=0 cellPadding=0 border=0 >
									<TBODY>
										...
										<TR>
											<TD width="130"><%tcWebApi_get("String_Entry","PresharedKeyText","s")%></TD>
											<TD><INPUT TYPE="TEXT" NAME="PreSharedKey_WPA3" STYLE="WIDTH:140" SIZE="48" MAXLENGTH="64" VALUE="<% If tcWebApi_get("WLan11ac_Entry","WPAPSK","h") <> "N/A" then tcWebApi_get("WLan11ac_Entry","WPAPSK","s") end if %>" onBlur="wpapskCheck(this)">(8~63个字符或64个十六进制字符串)</TD>
										</TR>
										<TR class='hide' style="display: none">
											<TD width="130"><%tcWebApi_get("String_Entry","KeyRenwalText","s")%></TD>
											<TD><INPUT TYPE="TEXT" id="keyRenewalInterval_WPA3" NAME="keyRenewalInterval_WPA3" SIZE="7" MAXLENGTH="7" onBlur="checkRekeyinteral(this.value, 0)">秒 (0 ~ 4194303)
											<script language="JavaScript" type="text/JavaScript">
												var rekeystr = "<% tcWebApi_get("WLan11ac_Entry","RekeyInterval","s") %>";
												if("N/A" == rekeystr || "" == rekeystr)
