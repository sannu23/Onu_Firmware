<%
if Request_Form("Mac_Flag") = "0" then
	tcWebApi_constSet("MacDupDetect_Entry","Active","0")
	TCWebApi_commit("MacDupDetect_Entry")
	TCWebApi_save()
elseif Request_Form("Mac_Flag") ="1" then
	tcWebApi_constSet("MacDupDetect_Entry","Active","1")
	TCWebApi_commit("MacDupDetect_Entry")
	TCWebApi_save()
end if	
%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML><HEAD><TITLE>MacDup Detect</TITLE>
...
border=0>
        ...
        <TR>
          ...
          <TD width=434 bgColor=#427594 height=33>
            ...
            color=#ffffff size=6><INPUT id=Selected_Menu type=hidden value="安全->MacDup Detect" name="Selected_Menu"> </FONT></B><SPAN 
      ...
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1>MacDup Detect</P></TD>
...
<% end if %>
        ...
        <TR>
          ...
          <TD width=7 background=/img/panel3.gif>　</TD>
          <TD>
            <FORM name="ConfigForm" action="/cgi-bin/mac_limit.asp" method="post">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>
                  <P>使能: <INPUT id=isFilter type="checkbox" name="isFilter" <%if tcWebApi_get("MacDupDetect_Entry","Active","h") = "1" then asp_Write("checked") end if%>></P>
...
function SubmitForm()
{
	...
	if(Form.isFilter.checked)
		Form.Mac_Flag.value = "1";
	else Form.Mac_Flag.value = "0";
