...
<HTML><HEAD><TITLE><%tcWebApi_get("String_Entry","Firewall1Text","s")%></TITLE>
...
border=0>
        ...
        <TR>
          ...
          <TD width=434 bgColor=#427594 height=33>
            ...
            value="<%tcWebApi_get("String_Entry","ContentSecurityText","s")%>-><%tcWebApi_get("String_Entry","ContentFirewallText","s")%>" name=Selected_Menu> </FONT></B><SPAN 
      ...
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0 id="mainTableSet">
        ...
        <TR>
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1><%tcWebApi_get("String_Entry","Firewall2Text","s")%></P></TD>
...
　　　　　　</TD></TR>
		  ...
		  <FORM name="ConfigForm" action="/cgi-bin/sec-firewall.asp" method="post">
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>
                  <P><%tcWebApi_get("String_Entry","Firewall3Text","s")%><SELECT onchange="ChangeLevel(this)" size=1 id="SecurityLevel" name="SecurityLevel"> 
        ...
        <TR id=protectatack1>
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1><%tcWebApi_get("String_Entry","Firewall7Text","s")%></P></TD>
          <TD width=7 bgColor=#ef8218>　</TD>
          <TD width=474>　</TD>
          <TD width=0></TD></TR>
        <TR id=protectatack2>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR id=AttackProtect>
                <TD width=10>&nbsp;</TD>
                <TD>
                  <P><%tcWebApi_get("String_Entry","Firewall8Text","s")%><INPUT id=enableAttackProtect onclick="setAttackProtect()" type="checkbox" name="enableAttackProtect" <%if tcWebApi_get("Firewall_Entry","firewall_status","h") = "1" then asp_Write("checked") end if%>>
				  </P></TD>
